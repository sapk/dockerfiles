...
DOCKER_PUSHIMAGE=sapk/gitea make -B docker-multi-amd64 docker-multi-arm docker-multi-arm64
DOCKER_MANIFEST=docker/manifest/gitea.yml DOCKER_PUSHIMAGE=sapk/gitea make -B docker-multi-update-manifest
